...
public class Polygon extends View {
    ...
    //一些标注
    private String[] explains = {"PM2.5"+"="+PM25, "NO2"+"="+NO2, "SO2"+"="+SO2, "O3"+"="+O3, "CO"+"="+CO, "PM10"+"="+PM10};
    //文字大小
...
//            Log.e("dd", print);
    ...
    public void setRealData(int[] realData) {
        ...
        PM25 = this.realData[0];
        NO2 = this.realData[1];
        SO2 = this.realData[2];
        O3 = this.realData[3];
        CO = this.realData[4];
        PM10 = this.realData[5];
        explains[0] = "PM2.5"+"="+PM25*35;
        explains[1] = "NO2"+"="+NO2*20;
        explains[2] = "SO2"+"="+SO2*10;
        explains[3] = "O3"+"="+O3*18;
        explains[4] = "CO"+"="+CO;
        explains[5] = "PM10"+"="+PM10*40;
